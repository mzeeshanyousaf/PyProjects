...
image = face_recognition.load_image_file("elonMusk.jpg")
...
unknown_image = face_recognition.load_image_file("barackObama2.jpg")
unknown_image = face_recognition.load_image_file("elonMusk.jpg")
unknown_image = face_recognition.load_image_file("tigerWoods.jpeg")
